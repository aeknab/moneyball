...
st.title("Kicktipp Dashboard")

# Sidebar Navigation with Buttons
st.sidebar.title("Navigation")
bundesliga_btn = st.sidebar.button("Bundesliga")
kicktipp_btn = st.sidebar.button("Kicktipp")
...
# Handle Bundesliga page
if bundesliga_btn or st.session_state.get('selected_page') == "Bundesliga":
    st.session_state.selected_page = "Bundesliga"
    ...
    with col1:
        ...
        if selected_season != st.session_state.selected_season:
            st.session_state.selected_matchday = '--'  # Reset Matchday
            st.session_state.selected_match = '--'     # Reset Fixture
    ...
    with col2:
        ...
        # Check if the matchday has changed
    ...
    # Extract match details and handle the display of logos and other match info
    if st.session_state.selected_match != '--':
        filtered_rows = df_matches_sorted[
            df_matches_sorted.apply(
        ...
        def display_team_data(df_season, team_data, team_name, team_tag):
            ...
            team_logo_path = f"/Users/andreas/Desktop/02 - Moneyball/Just the Tipp/06 - Logos/01 - Bundesliga/{team_tag}.svg.png"
