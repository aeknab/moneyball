...
def display_cross_table_view(df, selected_season, matchday):
    ...
    def add_logo_at_position(ax, team_tag, x, y, box_alignment=(0.5, 0.5)):
        ...
        if os.path.exists(team_logo_path):
            ...
            white_bg = Image.new("RGBA", team_logo.size, (255, 255, 255, 255))
            team_logo_with_bg = Image.alpha_composite(white_bg, team_logo)

            # Resize the image
            team_logo_resized = resize_image_to_bounding_box(team_logo_with_bg, target_width=30, target_height=30)
